...
public class MagdaMockDocumentTest {
    ...
    public void whenParseFakeMagdaRequest_shouldHaveCorrectServiceIdentification() {
        String input = """
                ...
                """;
        MagdaMockDocument document = MagdaMockDocument.fromString(input);
    ...
    public void whenInputIsInvalid_shouldThrowException() {
        String input = """
                <soapenv:Envelope>
        """;
        Assertions.assertThrows(MagdaMockSoapException.class, () -> MagdaMockDocument.fromString(input));
    }
}
