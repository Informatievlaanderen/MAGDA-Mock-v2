...
public record MockRestMapping(List<String> folderPath, List<String> queryParameters, Integer urlParametersSize,
    ...
    public static final List<MockRestMapping> MAPPINGS = List.of(
            ...
            new MockRestMapping(List.of("v1", "socZek", "socialeHuisvesting", "dossiers", "bijlage", "post"), List.of(), 0, List.of("dossierNummer", "partijCode", "bijlageIdentificatie"), "/v1/socZek/socialeHuisvesting/dossiers/bijlage", "POST"),
            ...
            new MockRestMapping(List.of("v1", "socZek", "socialeHuisvesting", "dossiers", "verwerkDossierActie", "post"), List.of(), 0, List.of("dossierNummer", "actie"), "/v1/socZek/socialeHuisvesting/dossiers/verwerkDossierActie", "POST"),
            ...
            new MockRestMapping(List.of("v1", "socZek", "socialeHuisvesting", "woningen", "vmswWoningId", "energiecorrectie", "get"), List.of("epcVersie"), 1, List.of(), "/v1/socZek/socialeHuisvesting/woningen/%s/energiecorrectie", "GET"),
